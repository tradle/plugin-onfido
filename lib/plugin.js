...
class Onfido {
    constructor(opts) {
        this.onFormsCollected = ({ req }) => __awaiter(this, void 0, void 0, function* () {
            if (this.mode !== 'after')
                return;
            ...
            yield this.updateCheck({ req, application, check });
        });
        this.updateCheck = ({ req, application, check, form }) => __awaiter(this, void 0, void 0, function* () {
            const onfidoApplicant = check.get('onfidoApplicant');
            const updatedApplicant = yield this.applicants.createOrUpdate({ req, application, check, form });
            if (!updatedApplicant)
                return;
            const uploadedAttachments = yield this.uploadAttachments({ req, application, check, form });
        ...
        this.unregisterWebhook = ({ url }) => __awaiter(this, void 0, void 0, function* () {
            ...
            yield this.secrets.del({ key: this.webhookKey, context: ONFIDO_WEBHOOK_CONTEXT });
        });
        this.registerWebhook = ({ url, events = constants_2.DEFAULT_WEBHOOK_EVENTS }) => __awaiter(this, void 0, void 0, function* () {
            ...
            const existing = yield this.onfidoAPI.webhooks.list();
            let webhook;
            if (existing) {
            ...
            if (!webhook) {
                ...
                webhook = yield this.onfidoAPI.webhooks.register({ url, events });
            }
            yield this.secrets.update({
                key: this.webhookKey,
                value: webhook,
        ...
        this.getWebhook = () => __awaiter(this, void 0, void 0, function* () {
            const webhook = yield this.secrets.get({
                key: this.webhookKey,
                context: ONFIDO_WEBHOOK_CONTEXT
            });
        ...
        this._handleForm = ({ req, application, check, form }) => __awaiter(this, void 0, void 0, function* () {
            ...
            yield this.updateCheck({ req, application, check, form });
        });
