    ...
    constructor(opts) {
        ...
        this.handleOnfidoError = ({ req, error }) => __awaiter(this, void 0, void 0, function* () {
            ...
            if (formType === constants_2.SELFIE) {
                prefill = { [constants_1.TYPE]: formType };
            }
            else {
                prefill = yield this.apiUtils.getResource(form);
                prefill = omit(prefill, [constants_1.SIG]);
            }
        ...
        this.processWebhookEvent = ({ req, res, body, desiredResult }) => __awaiter(this, void 0, void 0, function* () {
            let webhook;
            try {
                webhook = yield this.conf.get(this.webhookKey);
            }
            catch (err) {
