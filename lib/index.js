...
class Onfido {
    constructor(opts) {
        this['onmessage:tradle.Form'] = (req) => {
        ...
        this.processWebhookEvent = ({ req, res, desiredResult }) => __awaiter(this, void 0, void 0, function* () {
            ...
            let webhook;
            try {
                webhook = yield this.bot.conf.get(ONFIDO_WEBHOOK_KEY);
            }
            catch (err) {
            ...
            if (resource_type === 'report') {
                checkId = utils_1.parseReportURL(object.href).checkId;
            }
        ...
        this.updateApplicantAndCreateCheck = ({ req, application, state, form }) => __awaiter(this, void 0, void 0, function* () {
            ...
            try {
                yield this.createCheck({ state });
            }
            finally {
                yield this.bot.save(state);
            }
        });
        this.createCheck = ({ state }) => __awaiter(this, void 0, void 0, function* () {
        ...
        this.apiUtils = new api_utils_1.default(opts);
