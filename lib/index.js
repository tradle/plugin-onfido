...
class Onfido {
    constructor(opts) {
        ...
        this.createCheck = ({ application, state, reports }) => __awaiter(this, void 0, void 0, function* () {
            return yield this.checks.create({
                application,
                state,
                reports: reports || onfido_models_1.default.reportType.enum.map(({ id }) => id)
            });
        });
        ...
        const { logger, onfidoAPI, products, productsAPI, padApplicantName, formsToRequestCorrectionsFor, webhookKey = constants_2.DEFAULT_WEBHOOK_KEY
        // onFinished
         } = opts;
        this.logger = logger;
