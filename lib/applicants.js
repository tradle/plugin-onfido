...
class Applicants {
    constructor(main) {
        this.createOrUpdate = ({ req, application, check, form }) => __awaiter(this, void 0, void 0, function* () {
            if (!check) {
            ...
            if (check.get('onfidoApplicant')) {
                return yield this.update({ req, application, check, props });
            }
            try {
        ...
        this.update = ({ req, application, check, form, props }) => __awaiter(this, void 0, void 0, function* () {
            if (!props) {
                if (!form) {
        ...
        this.uploadSelfie = ({ req, application, check, form }) => __awaiter(this, void 0, void 0, function* () {
            ...
            try {
                const result = yield this.onfidoAPI.applicants.uploadLivePhoto(check.get('onfidoApplicant').id, {
                    file: data,
        ...
        this.uploadPhotoID = ({ req, application, check, form }) => __awaiter(this, void 0, void 0, function* () {
            utils_1.ensureNoPendingCheck(check);
            if (!form) {
            ...
            try {
                yield this.onfidoAPI.applicants.uploadDocument(check.get('onfidoApplicant').id, document);
