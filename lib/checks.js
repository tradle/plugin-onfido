    ...
    constructor(main) {
        this.create = ({ req, application, state, reports }) => __awaiter(this, void 0, void 0, function* () {
            ...
            const current = buildResource({
                ...
                rawData: utils_1.sanitize(check).sanitized,
                checkId: check.id,
        ...
        this.sync = () => __awaiter(this, void 0, void 0, function* () {
            ...
            for (const batch of batches) {
                yield Promise.all(pending.map((current) => __awaiter(this, void 0, void 0, function* () {
                    ...
                    yield this.processCheck({ application, state, current, update });
                })));
            }
        });
