...
class Checks {
    constructor(main) {
        this.create = ({ req, application, state, reports }) => __awaiter(this, void 0, void 0, function* () {
            ...
            const current = buildResource({
                ...
                .toJSON();
            yield this.processCheck({ req, application, state, current, update: check });
        ...
        this.processCheck = ({ req, application, state, current, update }) => __awaiter(this, void 0, void 0, function* () {
            ...
            if (current[constants_1.SIG]) {
                current = yield this.bot.versionAndSave(current);
            }
            else {
                yield this.bot.signAndSave(current);
            }
        ...
        this.processCompletedReport = ({ req, application, state, report }) => __awaiter(this, void 0, void 0, function* () {
            ...
            if (report.result === 'clear') {
                ...
                yield this.productsAPI.importVerification({
                    req,
                    application,
                    verification: yield this.bot.sign(verification)
                });
            }
        });
