...
const hasRequiredAddressProps = props => constants_2.REQUIRED_ADDRESS_PROPS.every(prop => props[prop] != null);
...
exports.getMessageForReports = (reports, status) => {
    const enumVals = onfido_models_1.default.reportType.enum;
