...
const setup = () => {
    ...
    const check = fixtures_1.default.checks['0cc317bc-00a5-4e4b-8085-4485fceab85a'][1];
...
test('common case', loudAsync((t) => __awaiter(this, void 0, void 0, function* () {
    const { onfido, state, application, check, pendingCheck } = setup();
    ...
    sinon.stub(onfido.onfidoAPI.checks, 'get').callsFake((props) => __awaiter(this, void 0, void 0, function* () {
        const { applicantId, checkId } = utils_1.parseCheckURL(check);
...
test('plugin methods', loudAsync((t) => __awaiter(this, void 0, void 0, function* () {
    const { onfido, 
    // state,
    application, check, pendingCheck } = setup();
