...
test('common case', loudAsync((t) => __awaiter(this, void 0, void 0, function* () {
    ...
    const createApplicantStub = sinon.stub(onfido.onfidoAPI.applicants, 'create').callsFake((props) => __awaiter(this, void 0, void 0, function* () {
        t.same(props, {
            "first_name": "MOOG",
            "last_name": "SONI",
            "dob": "1981-04-03",
    ...
    yield onfido.createOnfidoCheck({ application, check });
