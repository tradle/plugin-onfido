...
test('common case', loudAsync((t) => __awaiter(this, void 0, void 0, function* () {
    ...
    sinon.stub(onfido.productsAPI, 'requestEdit').callsFake(({ item, details }) => __awaiter(this, void 0, void 0, function* () {
...
test('plugin methods', loudAsync((t) => __awaiter(this, void 0, void 0, function* () {
    const { onfido, 
    // state,
